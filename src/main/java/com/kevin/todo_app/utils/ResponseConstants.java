package com.kevin.todo_app.utils;

public class ResponseConstants {
    public final static String SUCCESS = "Success request";
    public final static String ERROR = "An error has occurred";

    public final static String USER_CREATED = "Your account was created successfully";
    public final static String USER_UPDATED = "Your profile has been updated";
    public final static String PASSWORD_CHANGED = "Your password was updated";
    public final static String EMAIL_SENT = "The confirmation email has sent";
